    ...
    def _init_loading_tab(self):
        ...
        def refresh(arg:ttk.Progressbar):
            while True:
                ...
                try:
                    status  = self.comic_downloader.is_running
                    time.sleep(1)
                    self.tab_Frame.switch_to_tab(0)
                except AttributeError:
                    pass
        progressbar = ttk.Progressbar(root, orient="horizontal", length=100, mode="indeterminate")
